                ...
                <div class="table-responsive" data-toggle="lists" data-lists-values='["js-lists-values-employee-name"]'>
                    ...
                    <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            <th class="text-center">server usage</th>
                        </tr>
                        </thead>
                        <tbody id="search">
                        <?php
                        ...
                        if ($uniqe_class != null){
                            ...
                            for ($i = 0 ; $i < count($uniqe_class) ; $i++){
                                ?>
                                <tr>
                                    <td class="text-center"><?= htmlspecialchars($uniqe_class[$i]->academy_display_name.' '.$uniqe_class[$i]->academy_name, ENT_QUOTES) ?></td>
                                    ...
                                    <td class="text-center"><?= htmlspecialchars($uniqe_class[$i]->using_server, ENT_QUOTES) ?></td>
                                </tr>
                                <?php
                            } ?>
                        <?php } else { ?>
                            <tr>
                                <td width="60" style="color: red"><?= htmlspecialchars('x', ENT_QUOTES) ?></td>
