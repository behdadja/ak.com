...
class Get_join extends CI_Model {
    ...
    public function get_data4($from1, $join1, $condition1, $join2 = null, $condition2 = null, $join3 = null, $condition3 = null, $where = null, $or_where = null) {
        $this->db->select('*');
        $this->db->from($from1);
        if ($where !== null)
            $this->db->where($where);
    ...
    public function get_data_limit($from1, $join1, $condition1, $join2 = null, $condition2 = null, $join3 = null, $condition3 = null, $where = null, $limit = null) {
        $this->db->select('*');
        $this->db->from($from1);
        if ($limit !== null) {
            $this->db->limit($limit);
    ...
    function getStudentCoursesId($student_nc) {
        ...
        $qu = $this->db->get('courses_students');
        return $qu->result();
    }
