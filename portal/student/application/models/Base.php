...
//end delete
    ...
    public function get_announcement($var, $table, $where, $value_where_in, $where_in, $order_by){
        $this->db->select($var);
        $this->db->where($where);
        $this->db->where_in($value_where_in,$where_in);
        $this->db->order_by($order_by, "desc");
        $query = $this->db->get($table);
        return $query->result_object();
    }

//    public function get_announcement_crs($var, $table, $table1 = null, $where_join1 = null, $table2 = null, $where_join2 = null, $where = null, $order_by){
//        $this->db->select($var);
//        if ($table1 != null && $where_join1 != null)
//            $this->db->join($table1, $where_join1);
//        if ($table2 != null && $where_join2 != null)
//            $this->db->join($table2, $where_join2);
//        if ($where != NULL)
//            $this->db->where($where);
//        $this->db->order_by($order_by, "desc");
//        $query = $this->db->get($table);
