...
<section id="wrapper" class="error-page">
  <div class="error-box">
    <div class="error-body text-center">
      ...
      <?php endif; ?>
      <a href="<?php echo base_url(); ?>login-page" class="btn btn-info btn-rounded waves-effect waves-light m-b-40">ورود</a> </div>
    <footer class="footer text-center">1396 &copy; تمامی حقوق این برنامه برای nimadeveloper.ir محفوظ است.</footer>
  </div>
</section>
<!-- jQuery -->
