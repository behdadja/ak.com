    ...
    <div class="col-lg-3 col-sm-3 col-xs-12">
        <div class="white-box analytics-info">
            ...
            <ul class="list-inline two-part">
                ...
                <li class="text-right"><i class="ti-arrow-up text-success"></i> <span class="counter text-success"><?= $finalResult['count_of_questions']; ?></span></li>
            </ul>
        </div>
    </div>
    <div class="col-lg-3 col-sm-3 col-xs-12">
        <div class="white-box analytics-info">
            ...
            <ul class="list-inline two-part">
                ...
                <li class="text-right"><i class="ti-arrow-up text-purple"></i> <span class="counter text-purple"><?= $finalResult['count_of_correct_ans'] + $finalResult['count_of_wrong_ans']; ?></span></li>
            </ul>
        </div>
    </div>
    <div class="col-lg-3 col-sm-3 col-xs-12">
        <div class="white-box analytics-info">
            ...
            <ul class="list-inline two-part">
                ...
                <li class="text-right"><i class="ti-arrow-up text-info"></i> <span class="counter text-info"><?= $finalResult['count_of_correct_ans']; ?></span><i class="mdi mdi-arrow-right-bold-circle-outline"></i><span class="counter text-info"><?= $finalResult['correct_percent']; ?>%</span></li>
            </ul>
        </div>
    </div>
    <div class="col-lg-3 col-sm-3 col-xs-12">
        <div class="white-box analytics-info">
            ...
            <ul class="list-inline two-part">
                ...
                <li class="text-right"><i class="ti-arrow-down text-danger"></i> <span class="text-danger"><?= $finalResult['count_of_wrong_ans']; ?></span> <i class="mdi mdi-arrow-right-bold-circle-outline"></i><span class="text-danger"><?= $finalResult['wrong_percent']; ?>%</span></li>
            </ul>
        </div>
    </div>
</div>
