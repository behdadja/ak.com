<div class="col-sm-12">
    <div class="white-box">
        <h2 class="box-title m-b-0 text-success">دوره هایی که آزمون آنلاین داده اید : </h2>
        <hr>
            ...
            <table class="table table-bordered">
                <thead>
                    <tr>
                        ...
                        <th class="text-nowrap text-center">مشاهده نتیجه</th>
                    </tr>
                </thead>
                <tbody>
                        ...
                        <?php foreach ($courses_list as $course): ?>
                            <tr>
                                ...
                                <td class="text-nowrap text-center">
                                    ...
                                    <form class="" id="en_course_<?= $course->course_id; ?>" style="display:none;" action="/student/exams/result-view" method="post">
