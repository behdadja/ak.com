...
<div class="row">
    <div class="col-lg-12">
        <div class="white-box">
            <h3 class="box-title m-b-0">تیکت های بخش مدیریت</h3>
                    ...
                    foreach ($manager_tickets as $value):
                        ...
                        ?>
                            <tr>
                                ...
                                <?php if ($value->sender_type === 'mng'): ?>
                                    <td class="text-center"><?= $this->session->userdata('manage_name').'  (مدیر)'?></td>
                                <?php else: ?>
                                    <td class="text-center text-danger">شما</td>
                                <?php endif; ?>
                                <?php if ($value->receiver_type === 'mng'): ?>
                                    <td class="text-center"><?= $this->session->userdata('manage_name').'  (مدیر)'?></td>
                                <?php else: ?>
                                    <td class="text-center text-danger">شما</td>
                                <?php endif; ?>
                                ...
                                <td class="text-center"><a href="<?= base_url('student/tickets/info-manager-tickets/' . $value->ticket_id) ?>"><i class="glyphicon glyphicon-new-window text-info"></i></a></td>
                            </tr>
                        <?php
                    endforeach;
                else:
