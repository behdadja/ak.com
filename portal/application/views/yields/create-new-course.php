...
<form id="regForm" action="<?= base_url(); ?>training/insert-new-course" method="post" enctype="multipart/form-data" name="course_register">
                        ...
                        if (!empty($teacherError)):
                            ...
                            <div class="form-body">
                                ...
                                <div class="row">
                                    ...
                                    <!--/span-->
									<div class="form-group">
										<label class="control-label">نمایش این دوره در صفحه اصلی سامانه آموزکده (پس از دریافت تاییدیه)</label>
										<input type="checkbox" name='display_request' class="js-switch form-control" data-color="#6164c1" data-size="small" autocomplete="off"/>
									</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="col-md-1 form-group" style="margin: 0; padding: 0">
                                ...
                                <div class="input-append">
                                    <input type="text" maxlength="5" readonly disabled id='sat_clock' class="form-control add-on" name="sat_clock" placeholder="13:00" value="">
                                </div>
                            </div>
                            <div class="col-md-2 form-group">
                                ...
                                <div class="input-append">
                                    <input type="text" maxlength="5" readonly disabled id='sun_clock' class="form-control add-on" name="sun_clock" placeholder="13:00" value="">
                                </div>
                            </div>
                            <div class="col-md-2 form-group">
                                ...
                                <div class="input-append">
                                    <input type="text" maxlength="5" readonly disabled id='mon_clock' class="form-control add-on" name="mon_clock" placeholder="13:00" value="">
                                </div>
                            </div>
                            <div class="col-md-2 form-group">
                                ...
                                <div class="input-append">
                                    <input type="text" maxlength="5" readonly disabled id='tue_clock' class="form-control add-on" name="tue_clock" placeholder="13:00" value="">
                                </div>
                            </div>
                            <div class="col-md-2 form-group">
                                ...
                                <div class="input-append">
                                    <input type="text" maxlength="5" readonly disabled id='wed_clock' class="form-control add-on" name="wed_clock" placeholder="13:00" value="">
                                </div>
                            </div>
                            <div class="col-md-2 form-group">
                                ...
                                <div class="input-append">
                                    <input type="text" maxlength="5" readonly disabled id='thu_clock' class="form-control add-on" name="thu_clock" placeholder="13:00" value="">
                                </div>
                            </div>
                            <div class="col-md-1 form-group" style="margin: 0; padding: 0">
                                ...
                                <div class="input-append">
                                    <input type="text" maxlength="5" readonly disabled id='fri_clock' class="form-control add-on" name="fri_clock" placeholder="13:00" value="">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
