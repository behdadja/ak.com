        ...
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-info">
                    <div class="panel-heading">جست و جو کردن همه دوره های <?php echo $this->session->userdata('studentDName');?></div>
                    <div class="panel-wrapper collapse in" aria-expanded="true">
                        <div class="panel-body">
                            ...
                            <?php endif; ?>
                            <form action="<?php echo base_url(); ?>financial/get-all-course-tuition" method="post" name="class_register">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="student_nc" id="student_nc" class="form-control" placeholder="" required=""> <span class="help-block">کد ملی 10 رقمی <?php echo $this->session->userdata('studentDName');?> را وارد نمایید</زبspan></div>
