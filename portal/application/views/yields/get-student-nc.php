        ...
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-info">
                    <div class="panel-heading">جست و جو کردن همه دوره ها و آزمون های <?php echo $this->session->userdata('studentDName');?></div>
                    <div class="panel-wrapper collapse in" aria-expanded="true">
                        <div class="panel-body">
                            ...
                            <?php endif; ?>
                            <form action="<?php echo base_url(); ?>enrollment/search-all-student-info" method="post" name="class_register">
