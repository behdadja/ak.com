    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo base_url('tickets/answer-employee-tickets'); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="employee_nc" value="<?php echo htmlspecialchars($info_emp[0]->national_code, ENT_QUOTES); ?>">
...
<div class="media" style="background-color: #edf1f5;border-radius: 10px">
    <div class="media-left">
        ...
        <?php else: ?>
            <img src="<?= base_url('./assets/profile-picture/thumb/' . $info_emp[0]->pic_name); ?>" class="img-circle" style="width:45px">
        <?php endif; ?>
    </div>
    <div class="media-body">
        <h5 class="media-heading">
            <?php if($manager_tickets[0]->sender_type == 'mng'){
                ...
                echo $this->session->userdata('teacherDName') . ' ' . $info_emp[0]->first_name . ' ' . $info_emp[0]->last_name;
            } ?>
        ...
        foreach ($answer_manager_tickets as $answer):
            if ($answer->sender_type === 'emp'):
                ...
                <div class="media m-l-40" style="background-color: white;border-radius: 10px">
                    ...
                    <div class="media-body">
                        <h5 class="media-heading text-info"><?= $this->session->userdata('teacherDName') . ' ' . $info_emp[0]->first_name . ' ' . $info_emp[0]->last_name ?><small class="pull-right"><?= $answer->created_at ?></small></h5>
                        <hr>
