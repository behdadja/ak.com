        ...
        <div class="row">
            <div class="panel panel-info" style="background-color: #f7fcfc">
                ...
                <div class="col-md-12 text-center m-t-20">
                    <div class="col-md-10">
                        <div class="panel-heading"> ویرایش اطلاعات <?php echo $this->session->userdata('studentDName'); ?> : <?php echo $student_info[0]->first_name . " " . $student_info[0]->last_name; ?></div>
                    ...
                    <div class="col-md-2">
                        ...
                        <a href="" data-toggle="modal" data-target="#modal-pic">
                            <img src="<?= base_url('assets/profile-picture/thumb/' . $student_info[0]->pic_name); ?>" height="120" alt="user" style="border-radius: 10px;margin-bottom: 5px">
                ...
                <div class="panel-wrapper collapse in" aria-expanded="true">
                    <div class="panel-body">
                        ...
                        <form action="<?php echo base_url(); ?>users/update-student" enctype="multipart/form-data" method="post" name="user_register">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="first_name" id="first_name" class="form-control" value="<?php echo htmlspecialchars($student_info[0]->first_name, ENT_QUOTES); ?>" required oninvalid="setCustomValidity('لطفا نام را وارد کنید')" onchange="try {
                                                        setCustomValidity('');
                                                    } catch (e) {
                                                    }">
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="last_name" name="last_name" class="form-control" value="<?php echo htmlspecialchars($student_info[0]->last_name, ENT_QUOTES); ?>" required oninvalid="setCustomValidity('لطفا نام خانوادگی را وارد کنید')" onchange="try {
                                                        setCustomValidity('');
                                                    } catch (e) {
                                                    }">
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="first_name_en" name="first_name_en" class="form-control" value="<?php echo htmlspecialchars($student_info[0]->first_name_en, ENT_QUOTES); ?>">
                                        </div>
                                    </div>
                                    <!--/span-->
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="last_name_en" name="last_name_en" class="form-control" placeholder="" value="<?php echo htmlspecialchars($student_info[0]->last_name_en, ENT_QUOTES); ?>">
                                        </div>
                                    </div>
                                    <!--/span-->
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="father_name" name="father_name" class="form-control" value="<?php echo htmlspecialchars($student_info[0]->father_name, ENT_QUOTES); ?>" required oninvalid="setCustomValidity('لطفا نام پدر را وارد کنید')" onchange="try {
                                                        setCustomValidity('');
                                                    } catch (e) {
                                                    }">
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" maxlength="10" disabled id="national_code" class="form-control" value="<?php echo htmlspecialchars($student_info[0]->national_code, ENT_QUOTES); ?>" required oninvalid="setCustomValidity('لطفا کد ملی را وارد کنید')" onchange="try {
                                                        setCustomValidity('');
                                                    } catch (e) {
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" readonly value="<?= $birthday ?>" name="birthday" id="example-input2-group2" class="form-control auto-close-example" onkeyup="
                                var date = this.value;
...
<!--                                                <input type="text" readonly id="example-input2-group2" value="--><?//= $student_info[0]->birthday ?><!--" class="form-control">-->
...
<!--                                            </div>-->
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="fileinput fileinput-new input-group" data-provides="fileinput">
                                                                                    ...
                                                                                    <span class="input-group-addon btn btn-default btn-file"> <span class="fileinput-new">انتخاب فایل</span> <span class="fileinput-exists">تغییر</span>
                                                                                        <input type="hidden"><input type="file" value="<?php echo htmlspecialchars($student_info[0]->pic_name, ENT_QUOTES); ?>" name="pic_name"> </span> <a href="form-material-elements.html#" class="input-group-addon btn btn-default fileinput-exists" data-dismiss="fileinput">حذف</a>
                                                                                </div>
                                                                            </div>
                                                                            /span
                                                                        </div>-->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input onKeyPress="if (this.value.length == 11)
                                                        return false;" min="09000000000" max="99999999999" type="number" class="form-control" name="phone_num" id='phone_num' value="<?php echo htmlspecialchars($student_info[0]->phone_num, ENT_QUOTES); ?>" placeholder="09xxx" required oninvalid="setCustomValidity('لطفا تلفن همراه را وارد کنید')" onchange="try {
                                                                    setCustomValidity('');
                                                                } catch (e) {
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input  onKeyPress="if (this.value.length == 11)
                                                        return false;" min="01000000000" max="99999999999" type="number" name="tell" id='tell' value="<?php echo htmlspecialchars($student_info[0]->tell, ENT_QUOTES); ?>" class="form-control" placeholder="071xxx">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>کد پستی</label>
                                            <input type="text" maxlength="10" name="postal_code" value="<?php echo htmlspecialchars($student_info[0]->postal_code, ENT_QUOTES); ?>" class="form-control" placeholder="7367245698"> <span class="help-block">کد پستی 10 رقمی</span>
                                        </div>
                                    </div>
                                </div>
                                <!--/row-->
...
<div id="modal-pic" class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content text-center">
            ...
            <form class="form-horizontal" action="<?= base_url('student-update-pic'); ?>" enctype="multipart/form-data" method="post">
                <div class="modal-body">
                    <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>" />
                    <input type="hidden" name="national_code" class="form-control" value="<?php echo $student_info[0]->national_code ?>">
                    <div class="form-group">
