...
<body>
    ...
    <section id="wrapper" class="login-register">
        <div class="login-box login-sidebar" style="padding: 20px 20px 0 20px">
            <div class="white-box">
                <form class="form-horizontal form-material" id="loginform" action="<?php echo base_url(); ?>teacher/login" method='post'>
                    ...
                    <?php endif; ?>
                    <a href="javascript:void(0)" class="text-center db"><img src="<?php echo base_url(); ?>teacher/assets/images/logo/logo.png" alt="Home" /><br/></a>
                    ...
                    <div class="form-group" style="padding-right: 20px">
                        <div class="col-md-12">
                            ...
                            <a href="javascript:void(0)" id="to-recover" class="pull-right"><i class="fa fa-lock m-r-5"></i> پسورد خود را فراموش کرده اید؟</a> 
                        </div>
                    </div>
                    ...
                    <div class="form-group m-b-0">
                        <div class="col-sm-12 text-center">
                            ...
                            <a href="<?= base_url(); ?>student"><button type="button" class="btn btn-primary btn-block" name="button">ورود به پنل دانشجو</button></a>
                        </div>
                    </div>
                </form>
                <form class="form-horizontal" id="recoverform" action="index.html">
                    <div class="form-group ">
                        <div class="col-xs-12">
                            <h3>بازیابی پسورد</h3>
                            <p class="text-muted">ایمیل خود را وارد کنید دستورالعمل ها به شما ارسال می شود! </p>
                        </div>
                    </div>
                    <div class="form-group ">
                        <div class="col-xs-12">
