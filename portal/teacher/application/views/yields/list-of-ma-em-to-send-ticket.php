    ...
    <div class="white-box">
        <div class="table-responsive">
            <?php if ($this->session->flashdata('id')) : ?>
                <div class="alert alert-success">تیکت شما با موفقیت ارسال شد<span class="pull-right"><a href="<?= base_url('teacher/tickets/info-manager-tickets/' . $this->session->flashdata('id')) ?>" >مشاهده</a></span></div>
            <?php endif; ?>
                        ...
                        <?php foreach ($managers_info as $manager): ?>
                            <tr>
                                ...
                                <td class="text-nowrap text-center">
                                    ...
                                    <a class="mdi mdi-comment-check-outline text-inverse" alt="default" data-toggle="modal" data-target="#myModal_em_<?php echo htmlspecialchars($manager->academy_id, ENT_QUOTES); ?>"></a>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form class="" id='send_st_<?php echo htmlspecialchars($manager->manager_id); ?>' action="<?php echo base_url(); ?>teacher/tickets/send-to-manager" method="post" enctype="multipart/form-data">
