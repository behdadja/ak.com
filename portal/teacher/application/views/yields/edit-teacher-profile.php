...
<?php endif ;?>
<form class="form-horizontal form-material" action="<?= base_url(); ?>teacher/update-teacher-profile" method="post">
    <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>" />
<div class="col-md-3"></div><div class="col-md-6" style="background-color: #EDF1F5;border-radius:2%;padding: 2%;">
