    ...
    <div class="white-box">
        <div class="row">
            <?php foreach ($course_info as $student): ?>
                ...
                <div class="col-md-4">
                    <div class="col-md-6">
                        <a href="<?php echo base_url('teacher/courses/list_of_meeting/' . $student->course_id); ?>" class="btn btn-primary" style="width: 100%;float:left;margin-top: 5px">لیست جلسات</a>
                    </div>
                    <div class="col-md-6">
                        <a href="<?php echo base_url('teacher/courses/my-courses'); ?>" class="btn btn-primary" style="width: 100%;float:left;margin-top: 5px">دوره ها</a>
                    </div>
                </div>
            ...
            <table class="table table-bordered center" style="text-align: center">
                <thead>
                    <tr>
                        ...
                        <th style="text-align: center">تعداد غیبت</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    if (!empty($absence_status)) {
                                        ...
                                        if ($conditions == 1) {
                                            ?>
                                            <form action = "<?php echo base_url('courses/save'); ?>" method = "post">
